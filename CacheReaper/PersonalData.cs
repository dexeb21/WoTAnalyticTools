...
namespace CacheReaper
{
    public class PersonalData
    {
        ...
        public PersonalData(IList<object> personalresult)
        {
        ...
        //////////////////////////////////////////////////////////////////////////
        public int p35 { get { return (_size < 33) ? -1 : (int)_PersonalResult[35]; } }
        //////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Заработанно серебра (еще один)
        /// RAW[36];
        /// </summary>
        public int p36_tmenXP { get { return (_size < 33) ? -1 : (int)_PersonalResult[36]; } }
        //////////////////////////////////////////////////////////////////////////
        public int p37 { get { return (_size < 33) ? -1 : (int)_PersonalResult[37]; } }
        //////////////////////////////////////////////////////////////////////////
        public int p38 { get { return (_size < 33) ? -1 : (int)_PersonalResult[38]; } }
        //////////////////////////////////////////////////////////////////////////
        public int p39 { get { return (_size < 33) ? -1 : (int)_PersonalResult[39]; } }
        //////////////////////////////////////////////////////////////////////////
        public int p40 { get { return (_size < 33) ? -1 : (int)_PersonalResult[40]; } }
        //////////////////////////////////////////////////////////////////////////
        public int p41 { get { return (_size < 33) ? -1 : (int)_PersonalResult[41]; } }
        //////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// repair или autoRepairCost Автоматический ремонт техники
        /// RAW[42];
        /// </summary>
        public int p42_autoRepairCost { get { return (_size < 33) ? -1 : (int)_PersonalResult[42]; } }
        //////////////////////////////////////////////////////////////////////////
        public object p43 { get { return (_size < 33) ? -1 : (object)_PersonalResult[43]; } }
        //////////////////////////////////////////////////////////////////////////
        public object p44 { get { return (_size < 33) ? -1 : (object)_PersonalResult[44]; } }
        //////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Премиум вккаунт
        /// RAW[45];
        /// </summary>
        public bool p45_isPremium { get { return (_size < 33) ? false : (bool)_PersonalResult[45]; } }
        //////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Премиум коэфф на кредиты
        /// RAW[46];
        /// </summary>
        public int p46_premiumCreditsFactor10 { get { return (_size < 33) ? -1 : (int)_PersonalResult[46]; } }
        //////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Премиум коэфф на опыт
        /// RAW[47];
        /// </summary>
        public int p47_premiumXPFactor10 { get { return (_size < 33) ? -1 : (int)_PersonalResult[47]; } }
        //////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Коэфф за первую победу
        /// RAW[45];
        /// </summary>
        public int p48_dailyXPFactor10 { get { return (_size < 33) ? -1 : (int)_PersonalResult[48]; } }
        //////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Похоже на базовый коэфф без ПА для опыта и серебра
        /// RAW[49];
        /// </summary>
        public int p49_aogasFactor10 { get { return (_size < 33) ? -1 : (int)_PersonalResult[49]; } }
        //////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// markOfMastery Хз что это.
        /// RAW[50];
        /// </summary>
        public int p50_markOfMastery { get { return (_size < 33) ? -1 : (int)_PersonalResult[50]; } }
        //////////////////////////////////////////////////////////////////////////
        public object p51 { get { return (_size > 33) ? -1 : (object)_PersonalResult[51]; } }
    }
}
